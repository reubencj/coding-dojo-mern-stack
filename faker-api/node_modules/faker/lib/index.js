...
function Faker (opts) {
  ...
  var Fake = require('faker/lib/fake');
  self.fake = new Fake(self).fake;

  var Unique = require('faker/lib/unique');
  self.unique = new Unique(self).unique;

  var Mersenne = require('faker/lib/mersenne');
  self.mersenne = new Mersenne();

  var Random = require('faker/lib/random');
  self.random = new Random(self);

  var Helpers = require('faker/lib/helpers');
  self.helpers = new Helpers(self);

  var Name = require('faker/lib/name');
  self.name = new Name(self);

  var Address = require('faker/lib/address');
  self.address = new Address(self);

  var Animal = require('faker/lib/animal');
  self.animal = new Animal(self);

  var Company = require('faker/lib/company');
  self.company = new Company(self);

  var Finance = require('faker/lib/finance');
  self.finance = new Finance(self);

  var Image = require('faker/lib/image');
  self.image = new Image(self);

  var Lorem = require('faker/lib/lorem');
  self.lorem = new Lorem(self);

  var Hacker = require('faker/lib/hacker');
  self.hacker = new Hacker(self);

  var Internet = require('faker/lib/internet');
  self.internet = new Internet(self);

  var Database = require('faker/lib/database');
  self.database = new Database(self);

  var Phone = require('faker/lib/phone_number');
  self.phone = new Phone(self);

  var _Date = require('faker/lib/date');
  self.date = new _Date(self);

  var _Time = require('faker/lib/time');
  self.time = new _Time(self);

  var Commerce = require('faker/lib/commerce');
  self.commerce = new Commerce(self);

  var System = require('faker/lib/system');
  self.system = new System(self);

  var Git = require('faker/lib/git');
  self.git = new Git(self);

  var Vehicle = require('faker/lib/vehicle');
  self.vehicle = new Vehicle(self);

  var Music = require('faker/lib/music');
  self.music = new Music(self);

  var Datatype = require('faker/lib/datatype');
